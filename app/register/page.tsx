                ...
                <div className="bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 p-8 rounded-3xl shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative">
                        <div className="text-center mb-8">
                            <h1 className="text-3xl font-bold text-white mb-3">アカウント作成</h1>
                            <p className="text-slate-400">LogicalTaxを始めましょう</p>
                        </div>

                        {success ? (
                            <div className="text-center py-8">
                                <div className="mb-6 bg-emerald-500/10 border border-emerald-500/50 text-emerald-200 p-6 rounded-2xl">
                                    ...
                                    <p className="mt-2 text-emerald-300/80">ログインページへ移動します...</p>
                                </div>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-slate-300 mb-2">お名前（任意）</label>
                                    <div className="relative">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1.5 text-xs text-slate-500">6文字以上で設定してください</p>
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-slate-300 mb-2">パスワード（確認）</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <LockIcon />
                                        </div>
